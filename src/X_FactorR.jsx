  ...
  return (
    <div id="containerX">
      ...
      <div id="container">
        ...
        <button
          className={fastThinking ? "onR" : "offR"}
          id="Fast"
          onClick={() => {
        ...
        {/* DB X-Factors */}
        <button
          className={slantSlayer ? "onR" : "offR"}
          id="Slant"
          onClick={() => {
        ...
        <button
          className={deepPassDemon ? "onR" : "offR"}
          id="DPD"
          onClick={() => {
